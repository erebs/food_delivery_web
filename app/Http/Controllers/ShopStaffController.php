...
class ShopStaffController extends Controller
{
    ...
    {
        return view('shop.staff.AddStaff');
    }
        ...
        public function active_staff()
    {
        ...
        return view('shop.staff.ActiveStaff',['staff'=>$staff]);
    }
        ...
        public function edit_staff($fid)
    {
        ...
        return view('shop.staff.StaffEdit',['staff'=>$staff]);
    }
       ...
       public function blocked_staff()
    {
        ...
        return view('shop.staff.BlockedStaff',['staff'=>$staff]);
    }
