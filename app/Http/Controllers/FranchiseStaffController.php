...
class FranchiseStaffController extends Controller
{
    ...
    {
        return view('franchise.staff.AddStaff');
    }
    ...
    {
        $staff=staff::where('franchise_id',auth()->guard('franchise')->user()->id)->where('status','Active')->latest()->get();

        return view('franchise.staff.ActiveStaff',['staff'=>$staff]);
    }
        ...
        public function edit_staff($fid)
    {
        ...
        return view('franchise.staff.StaffEdit',['staff'=>$staff]);
    }
    ...
    {
        $staff=staff::where('franchise_id',auth()->guard('franchise')->user()->id)->where('status','Blocked')->latest()->get();

        return view('franchise.staff.BlockedStaff',['staff'=>$staff]);
    }
