...
@section('title')
 Item
  @endsection
  @section('head1') Edit Variant @endsection
@section('contents')
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{$item->GetItem->item}}</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                 ...
                                                 <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" placeholder="Enter Variant" id="variant" value="{{$item->variant}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" placeholder="Enter Price" id="price"  onkeyup="Price()" value="{{$item->normal_price}}">
                                                 ...
                                                 <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-control" id="isoffer">
                                                          ...
                                                          <option value="Yes" @if($item->is_offer=='Yes') selected  @endif>Yes</optio>                                                       
                                                            <option value="No" @if($item->is_offer=='No') selected  @endif>No</option>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="percent" onkeyup="Price()" value="{{$item->offer_percentage}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input type="number" class="form-control" id="oprice" value="{{$item->offer_price}}">
                                                  ...
                                                  <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="form-control" id="status">
                                                          ...
                                                          <option value="Active" @if($item->is_offer=='Active') selected  @endif>Active</optio>                                                       
                                                            <option value="Blocked" @if($item->is_offer=='Blocked') selected  @endif>Blocked</option>
