...
<!-- *************************************** -->
                                            ...
                                            <div class="new-arrival-content pr">
                                                <h4>{{$item->item}}
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="/merchant/edit-item/{{encrypt($item->id)}}" target="_blank">Edit Item</a>

                                                            @if($item->is_customize=='Yes')
                                                            <a class="dropdown-item" href="/merchant/add-variant/{{encrypt($item->id)}}">Add Variant</a>
                                                            @else
                                                            <a class="dropdown-item" href="/merchant/edit-price/{{encrypt($item->id)}}" target="_blank">Edit Price</a>
                                                            @endif
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown ms-auto text-end">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="/merchant/edit-variant/{{encrypt($f->id)}}" target="_blank">Edit Variant</a>
    ...
    function GetItems(val) {
        ...
        $.post("/merchant/get-items", {cat: val,itm: '{{$item->id}}', _token: "{{ csrf_token() }}"}, function(result) {
       ...
       function DeleteRel(val) {
        ...
        $.post("/merchant/delete-itemslist", {itm: val, _token: "{{ csrf_token() }}"}, function(result) {
      ...
      function GetItemslist() {
        ...
        $.post("/merchant/get-itemslist", {itm: '{{$item->id}}', _token: "{{ csrf_token() }}"}, function(result) {
        ...
        success:function(data)
        {
          if(data['success'])
          {
            ...
            Toastify({
              ...
              callback: function () {
               // alert("sss");
                window.location.href='/merchant/active-items'
              },
            }).showToast();
          }
