				...
				<div class="row">
					...
					<div class="col-xl-3 col-xxl-7">
						<div class="card">
							...
							<div class="card-body">	
								<div class="user-bx">
									<img src="{{asset('/admin/images/profile/small/pic1.jpg')}}" alt="">
									<div>
								...
								<ul class="user-list">
									<li><img src="{{asset('/admin/images/avatar/1.jpg')}}" alt=""></li>
									<li><img src="{{asset('/admin/images/avatar/2.jpg')}}" alt=""></li>
									<li><img src="{{asset('/admin/images/avatar/3.jpg')}}" alt=""></li>
									<li><img src="{{asset('/admin/images/avatar/4.jpg')}}" alt=""></li>
									<li><img src="{{asset('/admin/images/avatar/5.jpg')}}" alt=""></li>
									<li><img src="{{asset('/admin/images/avatar/6.jpg')}}" alt=""></li>
								</ul>
