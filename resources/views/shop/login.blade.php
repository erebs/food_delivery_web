                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="/administrator"><img src="{{asset('/admin/images/logo1.png')}}" alt="" style="width: 40%;"></a>
									</div>
                                    <h4 class="text-center mb-4">Sign in your shop account</h4>
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Enter mobile number" name="username" id="username">
