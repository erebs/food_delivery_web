...
<head>
  ...
  <!-- PAGE TITLE HERE -->
  <title>Grocery | @yield('title')</title>
...
<body>
                      ...
                      <li>
                        <div class="timeline-panel">
                          ...
                          <div class="media-body">
                            ...
                            <li class="nav-item">
                <a href="/merchant/dashboard" class="btn btn-primary d-sm-inline-block d-none"> <i class="fa fa-toggle-on" aria-hidden="true"></i>&nbsp   Visit Restaurent</a>
              </li>
                        </ul>
                    </div>
        </nav>
        ...
        <ul class="metismenu" id="menu">
          <li class="dropdown header-profile">
            ...
            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                ...
                @else
              <img src="{{ asset('admin/img/'.Auth::guard('shop')->user()->profile_image)}}" width="20" alt="">
              @endif
              <div class="header-info ms-3">
                <span class="font-w600 " style="color: white !important;"><b>{{Auth::guard('shop')->user()->proprietor}}</b> </span>
            
                <small class="text-end font-w400">Grocery Shop</small>
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="/grocery/shop-availability" class="dropdown-item ai-icon">
  ...
  <path d="M12 1C6.5 1 2 5.5 2 11c0 3.1 1.6 5.8 4 7.4V23l6-3.6 6 3.6v-4.6c2.4-1.6 4-4.3 4-7.4 0-5.5-4.5-10-10-10zM12 3c4.4 0 8 3.6 8 8 0 1.6-.5 3.1-1.4 4.4l-5.3-3.1V7H9.7l-5.3 3.1C3.5 14.1 3 12.6 3 11c0-4.4 3.6-8 8-8zm0 16.2c-1.4 0-2.7-.4-3.9-1.1L12 14l3.9 4.1c-1.2.7-2.5 1.1-3.9 1.1z"/>
</svg>

                <span class="ms-2">Availability </span>
              </a>
              <a href="/grocery/edit-profile" class="dropdown-item ai-icon">
                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                <span class="ms-2">Edit Profile </span>
              </a>
              
              <a href="/merchant/logout" class="dropdown-item ai-icon">
                ...
                <span class="ms-2">Logout </span>
                    ...
                    <li><a href="/grocery/dashboard" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              ...
              <span class="nav-text">Categories</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/grocery/add-category">Add new</a></li>
                            <li><a href="/grocery/active-categories">Active</a></li>
                            <li><a href="/grocery/blocked-categories">Blocked</a></li>
                        </ul>
                    </li>
             ...
             <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              ...
              <span class="nav-text">Items</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/grocery/add-item">Add new</a></li>
                            <li><a href="/grocery/active-items">Active</a></li>
                            <li><a href="/grocery/blocked-items">Blocked</a></li>
                            <li><a href="/grocery/category-items">Category Wise</a></li>
                        </ul>
                    </li>        
              ...
              <span class="nav-text">Delivery Staffs</span>
            </a>
                        <ul aria-expanded="false">
                            <li><a href="/grocery/add-staff">Add new</a></li>
                            <li><a href="/grocery/active-staff">Active</a></li>
                            <li><a href="/grocery/blocked-staff">Blocked</a></li>
                        </ul>
                    </li>
              ...
              <span class="nav-text">Reports</span>
                ...
                <ul aria-expanded="false">
                    <li><a href="/grocery/change-password">Change Password</a></li>
        ...
        <div class="copyright">
          <p><strong>Merchant Dashboard</strong> © 2023 All Rights Reserved</p>
