...
<body>
          ...
          <li class="dropdown header-profile">
            ...
            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
              ...
              <div class="header-info ms-3">
                ...
                <small class="text-end font-w400">Restaurant</small>
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="/merchant/shop-availability" class="dropdown-item ai-icon">
  ...
  <path d="M12 1C6.5 1 2 5.5 2 11c0 3.1 1.6 5.8 4 7.4V23l6-3.6 6 3.6v-4.6c2.4-1.6 4-4.3 4-7.4 0-5.5-4.5-10-10-10zM12 3c4.4 0 8 3.6 8 8 0 1.6-.5 3.1-1.4 4.4l-5.3-3.1V7H9.7l-5.3 3.1C3.5 14.1 3 12.6 3 11c0-4.4 3.6-8 8-8zm0 16.2c-1.4 0-2.7-.4-3.9-1.1L12 14l3.9 4.1c-1.2.7-2.5 1.1-3.9 1.1z"/>
              ...
              <a href="/merchant/edit-profile" class="dropdown-item ai-icon">
              ...
              <a href="/merchant/logout" class="dropdown-item ai-icon">
                ...
                <span class="ms-2">Logout </span>
                    ...
                    <li><a href="/merchant/dashboard" class="ai-icon" aria-expanded="false">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              ...
              <span class="nav-text">Categories</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/merchant/add-category">Add new</a></li>
                            <li><a href="/merchant/active-categories">Active</a></li>
                            <li><a href="/merchant/blocked-categories">Blocked</a></li>
                        </ul>
                    </li>
             ...
             <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
              ...
              <span class="nav-text">Items</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/merchant/add-item">Add new</a></li>
                            <li><a href="/merchant/active-items">Active</a></li>
                            <li><a href="/merchant/blocked-items">Blocked</a></li>
                            <li><a href="/merchant/category-items">Category Wise</a></li>
                        </ul>
                    </li>        
              ...
              <span class="nav-text">Delivery Staffs</span>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/merchant/add-staff">Add new</a></li>
                            <li><a href="/merchant/active-staff">Active</a></li>
                            <li><a href="/merchant/blocked-staff">Blocked</a></li>
                        </ul>
                    </li>
              ...
              <span class="nav-text">Reports</span>
                ...
                <ul aria-expanded="false">
                    <li><a href="/merchant/change-password">Change Password</a></li>
