...
@section('title')
 Staff
  @endsection
  @section('head1') Active Delivery Staff @endsection
@section('contents')
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Active Delivery Staff</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													...
													<div class="dropdown ms-auto text-end">
														...
														<div class="dropdown-menu dropdown-menu-end">
															<a class="dropdown-item" href="/grocery/view-staff/{{encrypt($f->id)}}">View Profile</a>
															<a class="dropdown-item" href="/grocery/edit-staff/{{encrypt($f->id)}}">Edit Profile</a>
